...
declare
Transaction
NewCellT = {NewTrans Transaction}

N = 100 % number of accounts
Accounts = {Tuple.make accounts N}

% create all the accounts
for I in 1..N do
   Accounts.I = {NewCellT 0}
end

% transfer money from Acc1 to Acc2: return true if succeeded
proc {Transfer Acc1 Acc2 Money ?B}
   {Transaction proc {$ T _}
		   {T.assign Accounts.Acc1 {T.access Accounts.Acc1}-Money}
		   {T.assign Accounts.Acc2 {T.access Accounts.Acc2}+Money}
		end B _}
end
...
fun {Get Acc1}
   {Transaction fun {$ T}
		   {T.access Accounts.Acc1}
		end _}
end

{Browse {Get 1}}
{Browse {Transfer 1 2 100}}
{Browse {Get 2}}
{Browse {Transfer 3 1 50}}
{Browse {Get 3}}